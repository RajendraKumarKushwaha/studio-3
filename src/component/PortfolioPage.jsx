...
const images = [
  { src: "https://cdn.pixabay.com/photo/2021/07/05/09/35/bride-6388640_1280.jpg", title: "Wedding Moments" },
  { src: "https://cdn.pixabay.com/photo/2019/06/25/04/01/wedding-4297343_1280.jpg", title: "Pre-Wedding Moments" },
  { src: "https://cdn.pixabay.com/photo/2025/01/11/09/08/wedding-9325558_1280.jpg", title: "Haldi Moments" }
  ...
  return (
    <div className="py-24 bg-[#C0984B] flex items-center justify-center">
      <div className="container px-4 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-white text-2xl md:text-3xl tracking-wider  mb-10 heading">
